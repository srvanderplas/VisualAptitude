...
\newtext{(this phrasing is intentionally ambiguous to prevent biasing participants and is commonly used in other studies \cite{wickham2010graphical, majumder2013validation}).}
