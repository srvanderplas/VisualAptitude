...
\comments{This is going into the right direction, but a few pieces are still missing, 
...
qplot(data=lineup.summary.categorical, x=value, y=lineup, geom="boxplot", fill=I("grey70")) + 
