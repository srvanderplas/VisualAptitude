...
This aspect of lineups provides an important tool in the evaluation of graphical findings. Similarly, lineups allow for an objective evaluation of an individual's visual ability based on the general's population performance on a lineup.
