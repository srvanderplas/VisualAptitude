...
<<lineup-types,echo=F, fig.cap="Plot of scaled scores for different types of lineups", fig.width=3, fig.height=8, out.width=".9\\linewidth">>=
lineup.type.sum$plot.type <- str_replace(lineup.type.sum$plot.type, "rotated", "rot")
lineup.type.sum$plot.type <- factor(lineup.type.sum$plot.type, levels=c("boxplot", "jitter.boxplot", "violinplot", "tree.boxplot", "scatterplot", "density", "stacked.bar", "qq.line", "qq.line.error", "qq.line.error.rot"))
