...
\comment{Next few steps for the analysis: (1) I think we should add a linear model for lineup scores that includes the demographics of participants as well; (2)}
