...
\comment{you can dare to go into a bit of math here - introduce a bit of the lineup math here.  random variable and approximate distribution, explanation for choosing lineups of size 20. }
