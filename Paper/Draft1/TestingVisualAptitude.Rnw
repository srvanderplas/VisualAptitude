...
\newtext{The lineup protocol~\cite{hofmann2012graphical,wickham2010graphical, buja2009statistical} is a testing framework that allows us to quantify the significance of graphical findings with the same mathematical rigor as conventional hypothesis tests. }
