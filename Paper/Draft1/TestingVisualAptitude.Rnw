...
<<lineup-types,echo=F, fig.cap="Plot of scaled scores for different types of lineups\\label{fig:plottypesdensity}", fig.width=3, fig.height=6, out.width=".9\\linewidth", warning=F, message=F>>=
...
lineup.type.sum2$plot.type <- factor(lineup.type.sum2$plot.type, 
                                     ...
                                     labels=c("Violin Plot", "Boxplot + \nOverlaid Data", "Bee Swarm Boxplot", "Boxplot", 
