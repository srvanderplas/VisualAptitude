...
\begin{figure}[htp]
\centering
\includegraphics[width=\linewidth,trim=0cm .5cm 0cm .25cm]{lineup}
...
\begin{figure}[ht]
<<ResultsScaledScores, echo=F, include=T, fig.width=4.5, fig.height=4, out.width='.9\\linewidth', warning=F, message=F>>=
...
<<lineupblockpca, echo=F, warning=F, message=F, fig.cap="Principal Component influence plot, showing each input variable's contribution to the principal component, scaled by the proportion of variability in the data contained in the principal component.", fig.width=6, fig.height=4>>=
