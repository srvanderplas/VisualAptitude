...
\begin{figure}[ht]
<<VisReasoningSPM,echo=FALSE,fig.pos="ht", include=T, eval=T, fig.width=8,fig.height=8, message=F, warning=F>>=
...
\begin{figure}[ht]
<<LineupTypeSPM,echo=FALSE,include=T, eval=T, fig.width=4,fig.height=6.5, message=F, warning=F>>=
...
\begin{figure}[ht]
<<lineupblockpca, echo=F, warning=F, message=F, fig.width=6, fig.height=4>>=
...
\begin{figure}[ht]
<<lineup-types,echo=F, fig.width=4, fig.height=8, out.width=".9\\linewidth", warning=F, message=F>>=
...
<<lineup-types-scores,echo=F,fig.width=6, fig.height=12, out.width="\\linewidth", warning=F, message=F>>=
