...
lineup.type.sum2$plot.type <- factor(lineup.type.sum2$plot.type, levels=c("boxplot", "jitter.boxplot", "violinplot", "tree.boxplot", "scatterplot", "density", "stacked.bar", "qq.line", "qq.line.error", "qq.line.error.rot"))
...
lineup.type.sum2$plot.type <- str_replace(lineup.type.sum$plot.type, "error", "err")
lineup.type.sum2$plot.type <- factor(lineup.type.sum$plot.type, levels=c("boxplot", "jitter.boxplot", "violinplot", "tree.boxplot", "scatterplot", "density", "stacked.bar", "qq.line", "qq.line.error", "qq.line.error.rot"))
...
qplot(data=lineup.type.sum3, 
      x=testscore, y=lineup.pct, geom="jitter") + 
