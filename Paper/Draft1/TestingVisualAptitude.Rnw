...
\newtext{The lineup protocol~\cite{hofmann2012graphical,wickham2010graphical, buja2009statistical} is introducing a testing framework that allows to quantify the significance of graphical findings with the same mathematical rigor as conventional hypothesis tests. }
