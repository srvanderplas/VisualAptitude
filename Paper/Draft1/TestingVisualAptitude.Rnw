...
Similarly, the correlation  between having taken a statistics class and having been involved in mathematics or statistics research is high. Only one student is doing research who has (not yet?) taken a statistics course. 
...
\newtext{The survey consisted of three sets of different types of lines. Examples lineups for each type of plot are provided in Appendix \ref{app:lineuptypes}. 
}
\newtext{
