...
### Weaknesses
   ...
   Q1. Are all the experimental design choices properly motivated? (refer to
   the first concern of R1).
   Q2. Are the experimental procedure sufficiently detailed? (refer to the
   second concern of R1 and )
   Q3. The results of statistical analysis do not seem to be conclusive, are
   the interpretations of these results properly revised? (refer to the
   third concern of R1)
   Q4. Does the revision contain additional discussion of why PCA is a
   ...
   R2)
   Q5. Does the revision has the clear description of "most different"?
   (refer to the first concern of R3)
   Q6. Does the revision has the proper discussion of visualization design
   (refer to the second concern of R3)
   Q7. Does the revision resolve a potential concern of confounding factors
   (refer to the conern of R3)
   Q8. Does the revision have an explicit related works section? (refer to
   the last concern of R3)
   Q9. Does the revision handle all the minor issues raised by reviewers?
