...
%% Uncomment below to include a teaser figure.
   \teaser{
      ...
      %  \hfill
        ...
        \centering
          \includegraphics[height=.5\textwidth]{Figure/fig-biplots-pca5-1}\hfill\newline
          \includegraphics[height=.5\textwidth]{Figure/fig-biplots-pca5-2}\hfill\newline
        
        (b) Biplots of visuo-spatial tests and lineup task.
\end{minipage}
\hfill
    \caption{\label{fig:lineup}On the left a sample lineup of boxplots is shown. Participants are asked to identify the most different plot.  %Participants are instructed to choose the plot which appears most different from the others. 
